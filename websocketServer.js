...
class WebSocketServer {
        ...
        this.wss.on('connection', (ws, req) => {
            ...
            ws.on('message', (message) => {
                try {
                    ...
                    if (data.type === 'action') {
                        console.log(`Processing immediate action from user ${userId} (${username})`);
                    ...
                    if (data.lat !== undefined && data.lng !== undefined) {
                        ...
                        if (data.showLocationToEveryone === undefined && this.userLocations.has(userId)) {
                        ...
                        const sendImmediately = data.immediate === true || data.forceUpdate === true;
    ...
    handleVisibilityChange(userId, showLocationToEveryone) {
        if (this.userLocations.has(userId)) {
            ...
            } else if (previousVisibility === false && showLocationToEveryone === true && userData.lat !== undefined && userData.lng !== undefined) {
    ...
    scheduleDelayedLocationUpdate(userId, locationData) {
        ...
        console.log(`Scheduled delayed location update for user ${userId} in ${this.locationUpdateInterval}ms`);
    }
